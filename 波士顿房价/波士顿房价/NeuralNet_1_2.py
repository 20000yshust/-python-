...
from DataReader_1_3 import *
from HyperParameters_1_1 import *
from TrainingHistory_1_0 import *
from LossFunction_1_1 import *
from ClassifierFunction_1_1 import *
...
class NeuralNet_1_2(object):
    ...
    def train(self, dataReader, checkpoint=0.1):
        ...
        loss_function = LossFunction_1_1(self.hp.net_type)
        loss = 10
        ...
        for epoch in range(self.hp.max_epoch):
            ...
            for iteration in range(max_iteration):
                ...
                # get z from x,y
                batch_z = self.forwardBatch(batch_x)
                # calculate gradient of w and b
                dW, dB = self.backwardBatch(batch_x, batch_y, batch_z)
                # update w,b
                self.update(dW, dB)
